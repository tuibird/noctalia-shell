...
Usage:
    python3 colors.py IMAGE_PATH [OPTIONS]
...
Example:
    python3 colors.py ~/wallpaper.png --material --both
    python3 colors.py ~/wallpaper.jpg --dark -o theme.json

Author: Noctalia Shell
License: MIT
"""
...
Examples:
  python3 colors.py wallpaper.png --material --both
  python3 colors.py wallpaper.jpg --dark -o theme.json
  python3 colors.py ~/Pictures/bg.png --normal --light
        """
    )
